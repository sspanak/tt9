...
_**Примечание 2:** В мессенджерах необходимо включить настройку "Отправлять с ENTER" или аналогичную, чтобы отправлять сообщения с OK. Если в приложении нет такой настройки, это обычно означает, что оно не позволяет отправлять сообщения таким образом._
...
#### Отправка сообщений с OK в Facebook Messenger
_Раздел: Настройки → Первоначальная настройка._

Отправка сообщений с помощью клавиши OK в Messenger стала невозможной с июня 2024 года. Недавнее обновление приложения сделало кнопку Отправить недоступной для всех клавиатур. Если у вас есть технические знания и идеи, как снова включить эту функцию, напишите в [эту проблему GitHub](https://github.com/sspanak/tt9/issues/558).
