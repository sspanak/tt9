...
#### Клавиша фильтра
- **Нажатие:** Фильтрация списка подсказок. См. [выше](#filter-suggestions-key-default-d-pad-up), как работает фильтрация слов.
...
- **Смахивание вверх при наличии подсказок:** Фильтрация списка подсказок. См. [выше](#filter-suggestions-key-default-d-pad-up).
