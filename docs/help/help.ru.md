...
_**Примечание:** Чтобы отправлять сообщения клавишей OK в приложениях для обмена сообщениями, откройте Настройки → Клавиатура, прокрутите вниз до раздела «Совместимость» и включите параметр «Отправлять сообщения клавишей OK»._
...
#### Клавиша редактирования слова:
Редактирует слово, в котором находится текстовый курсор.

В режиме редактирования доступны следующие действия:
- **Нажмите клавишу 1-9:** Заменяет текущую выбранную букву на другую.
- **Удерживайте клавишу Влево/Вправо:** Переход к предыдущей/следующей букве.
- **Нажмите клавишу OK:** Переход к следующей букве. Если букв больше нет, редактирование завершится, слово будет сохранено, и после него автоматически добавится пробел (если соответствующая настройка включена).
- **Нажмите клавишу Backspace:** Удаляет текущую букву.
- **Нажмите клавишу Фильтр:** Дублирует текущую букву. Например, если текущая буква "а", нажатие Фильтр превратит её в "аа".
- **Нажмите клавишу 0:** Завершает редактирование и сохраняет слово.

**Устройства с сенсорным экраном:**
- **Коснитесь буквы в списке предложений:** То же самое, что выбрать букву и нажать OK.
- **Нажмите и удерживайте последнюю букву слова:** Выбирает букву, завершает редактирование, но не добавляет автоматически пробел после слова.

Вы также можете использовать режим редактирования для ввода новых слов. Например, если вы хотите набрать "Anakin", которого нет в словаре, просто нажмите соответствующие клавиши: 2-6-2-5-4-6. Это даст бессмысленное слово, которое можно легко превратить в "Anakin", заменив буквы на правильные.
...
#### Клавиша скрытия клавиатуры:
Скрывает клавиатуру. Чтобы снова её показать, просто начните печатать или коснитесь текстового либо числового поля.
...
#### Клавиша показа эмодзи:
_Только в режиме Предсказания._

Открывает панель эмодзи. Это быстрый способ многократно нажимать клавишу 1 в режиме Предсказания.
...
#### Клавиша переключения предиктивного режима:
Переключает между режимом Предсказания и режимом ABC. По сути, это то же самое, что включать и выключать режим Предсказания.
...
- **Добавить слово (Комбинация по умолчанию: удерживайте ✱, клавиша 1).** То же, что и нажатие [Добавить слово](#клавиша-добавления-слова).
- **Редактировать слово (Комбинация по умолчанию: удерживайте ✱, клавиша 2).** То же, что и нажатие [Редактирование слова](#клавиша-редактирования-слова).
...
- **Показать экран настроек (Комбинация по умолчанию: удерживайте ✱, клавиша 9).** То же, что и нажатие [Настроек](#клавиша-настроек).
...
Как однажды сказал Генри Форд: «Он может быть любого цвета, какого пожелает покупатель, при условии, что он чёрный».
