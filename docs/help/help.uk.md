...
- **У режимі Чонджиін (Корейська):**
  ...
  - **Подвійне натискання:** вводить знаки пунктуації.
  - **Кілька натискань:** вводить емодзі.
  - **Натискання 1-1-1-3:** вводить додані емодзі (їх потрібно додати через [клавішу Додати слово](#клавіша-додати-слово)).
  - **Утримування:** вводить "1".
