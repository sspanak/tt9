...
#### Клавіша фільтра
- **Натискання:** Фільтрація списку підказок. Див. [вище](#filter-suggestions-key-default-d-pad-up), як працює фільтрація слів.
...
- **Проведення вгору з підказками:** Фільтрація списку підказок. Див. [вище](#filter-suggestions-key-default-d-pad-up).
