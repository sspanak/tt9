...
_**Примітка:** Щоб надсилати повідомлення клавішею OK у застосунках для обміну повідомленнями, відкрийте Налаштування → Клавіатура, прокрутіть вниз до розділу «Сумісність» і ввімкніть параметр «Надсилати повідомлення клавішею OK»._
...
#### Клавіша Редагувати слово:
Редагує слово, в якому знаходиться текстовий курсор.

У режимі редагування доступні такі дії:
- **Натисніть клавішу 1-9:** Замінює поточну вибрану літеру на іншу.
- **Утримуйте клавішу Ліворуч/Праворуч:** Перехід до попередньої/наступної літери.
- **Натисніть клавішу OK:** Перехід до наступної літери. Якщо літер більше немає, редагування завершиться, слово буде збережене, і після нього автоматично додасться пробіл (якщо відповідне налаштування увімкнено).
- **Натисніть клавішу Backspace:** Видаляє поточну літеру.
- **Натисніть клавішу Фільтр:** Дублює поточну літеру. Наприклад, якщо поточна літера "а", натискання Фільтр перетворить її на "аа".
- **Натисніть клавішу 0:** Завершує редагування і зберігає слово.

**Пристрої з сенсорним екраном:**
- **Торкніться літери у списку підказок:** Те саме, що вибрати літеру і натиснути OK.
- **Торкніться та утримуйте останню літеру слова:** Вибирає літеру, завершує редагування, але не додає автоматично пробіл після слова.

Ви також можете використовувати режим редагування для введення нових слів. Наприклад, якщо хочете надрукувати "Anakin", якого немає в словнику, просто натисніть відповідні клавіші: 2-6-2-5-4-6. Це дасть беззмістовне слово, яке легко перетворити на "Anakin", замінивши літери на правильні.
...
#### Клавіша Сховати клавіатуру:
Ховає клавіатуру. Щоб знову її показати, просто почніть вводити текст або торкніться текстового чи числового поля.
...
#### Клавіша Показати емодзі:
_Лише в режимі Прогнозування._

Відкриває панель емодзі. Це скорочений спосіб багаторазово натискати клавішу 1 у режимі Прогнозування.
...
#### Клавіша Перемкнути режим Прогнозування:
Перемикає між режимом Прогнозування та режимом ABC. Фактично це те саме, що увімкнути або вимкнути режим Прогнозування.
...
- **Додати слово (комбінація за замовчуванням: утримання ✱, клавіша 1).** Те ж саме, що натискання [Додати слово](#клавіша-додати-слово).
- **Редагувати слово (комбінація за замовчуванням: утримання ✱, клавіша 2).** Те ж саме, що натискання [Редагувати слово](#клавіша-редагувати-слово).
...
- **Відкрити екран налаштувань (комбінація за замовчуванням: утримання ✱, клавіша 9).** Те ж саме, що натискання [Відкрити налаштування](#клавіша-відкрити-налаштування).
...
## Голосове введення
Голосове введення дозволяє перетворювати мовлення на текст, подібно до Gboard. Як і інші клавіатури, Traditional T9 не виконує розпізнавання мовлення самостійно, а використовує служби голосового введення Android.
...
3. Надайте TT9 дозвіл на використання мікрофона.
...
TT9 також підтримує альтернативні методи голосового введення без Google, зокрема Futo Voice або Sayboard. Якщо доступно кілька методів, TT9 запропонує вибрати один. Якщо встановлено лише один метод без Google, він буде використаний автоматично.
...
Як колись сказав Генрі Форд: «Він може бути будь-якого кольору, якого побажає клієнт, за умови, що він чорний».
