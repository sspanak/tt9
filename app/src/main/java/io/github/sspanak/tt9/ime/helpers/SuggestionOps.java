...
public class SuggestionOps {
	...
	public SuggestionOps(@NonNull SettingsStore settings, @NonNull ResizableMainView mainView, @NonNull ConsumerCompat<String> onDelayedAccept, @NonNull Runnable onSuggestionClick) {
