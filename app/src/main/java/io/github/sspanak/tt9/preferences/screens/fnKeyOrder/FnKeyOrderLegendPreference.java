...
public class FnKeyOrderLegendPreference extends PreferencePlainText {
	...
	private void populate() {
		StringBuilder content = new StringBuilder(__(R.string.fn_key_order_legend))
			...
			.append("\n8 = OK\n")
			.append("\nL = ").append(__(R.string.accessibility_key_left))
			.append("\nR = ").append(__(R.string.accessibility_key_right))
			.append("\nC = ").append(__(new CmdEditText().getName()))
			.append("\nE = ").append(__(new CmdShowEmojis().getName()))
			.append("\nN = ").append(__(new CmdNextLanguage().getName()))
			.append("\nT = ").append(__(new CmdTogglePredictiveMode().getName()))
			.append("\nV = ").append(__(new CmdVoiceInput().getName()))
			.append("\n\n")
