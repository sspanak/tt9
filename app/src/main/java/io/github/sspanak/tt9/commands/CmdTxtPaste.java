...
public class CmdTxtPaste implements Command {
	...
	@Override public int getIcon() { return io.github.sspanak.tt9.R.drawable.ic_txt_paste; }
	@Override public int getName() { return 0; }
	@Override public int getHardKey() { return 9; }
	@Override public int getPaletteKey() { return io.github.sspanak.tt9.R.id.soft_key_9; }
