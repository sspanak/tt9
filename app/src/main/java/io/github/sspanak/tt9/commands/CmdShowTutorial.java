...
public class CmdShowTutorial implements Command {
	...
	@Override @Nullable public String getName(@Nullable Context context) { return null; }

	@Override
	public boolean isAvailable(@Nullable TraditionalT9 tt9) {
		return tt9 != null && !tt9.getSettings().getTutorialSeen() && !tt9.isTouchExplorationEnabled();
	}
